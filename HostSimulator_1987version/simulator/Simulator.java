...
public class Simulator {
	...
	public final static int SO_TIMEOUT = 0;				/** Block socket operations for every millisecond */
	...
	public static String read (BufferedReader bufferedReader, int transferType, int length) throws Exception {
		...
		if (1 == transferType) {
			...
			byte ETX 		= 0x03;
			chrBuf = new char[1];		// Variable length starts with Graphical length header
			while(true) {
