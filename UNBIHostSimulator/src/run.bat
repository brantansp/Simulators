@Title FSS 7898 -UNBI Host Simulator %Date% %Time%
@set path=C:\Program Files\Java\jdk180101\bin
...
:x
@cls
@java -server -classpath "%LOCALCLASSPATH%" simulator.HostSimulator 7898 -Xincgc -Xms512M -Xmx512M -Xincgc -XSS:256M
